...
- `web/engine/record.js` is the single definition of what a save writes. Change it and `web/engine/savecheck.js` checks the payload headlessly with the network mocked; the play page must not build those paths itself.
